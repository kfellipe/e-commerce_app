...
class users extends conn {
    ...
    public function updateUserColor($backColor, $predColor){
        return mysqli_query($this->conn, "UPDATE users SET Back_Colors = '$backColor', Pred_Color =  '$predColor' WHERE Id_Person = ".mysqli_fetch_assoc($this->getUserByName($_COOKIE['logado']))['Id_Person']);
    }
