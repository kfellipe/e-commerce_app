        ...
        <section class="container-crud_perfil">
            <table>
                ...
                <tr>
                    <th>
                        <form action="../../Controller/Router.php" method="POST">
                            <button type="button" class="btn" name="custom" onclick="header('customizar-perfil')">Customizar</button>
                            <button type="button" class="btn" name="delete" onclick="header('deletar-usuario')">Deletar Usuário</button>
                            <button type="button" class="btn" name="update" onclick="header('atualizar-usuario')">Atualizar Usuário</button>
